%% Create robust stability charts for CCC with 4 vehicles
clear; clc; % close all;
...
n=3;            % number of follower vehicles
gamma=[1 1 1    % adjacency matrix (relevant part)
       0 1 0
       0 0 1].';
...
beta=[0	beta02	0
      0	betah	0
      0 0       betah].';
xi=[sigma   sigma   sigma
    0       tau     0
    0   	0       tau].';

% vehicle number of HV
humandriver=[1,2];%+1 line
...
par.Niteration=4;
par.threshold=5e-3;   % 5e-3 (p=0, 5, 10) or 1e-6 (p=15, 20, 25)
