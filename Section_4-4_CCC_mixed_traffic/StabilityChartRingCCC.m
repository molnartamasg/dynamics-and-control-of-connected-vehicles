%% Create analytical stability charts for the ring setup with CCC
clear; %close all; clc;

%% Parameters
% total number of vehicles and number of CAVs
Ntotal=60;	% 24, 60
NN=20;      % 8, 12, 20, 30
% HV
kappah=0.6;
...
xlabel('\beta_{01} [1/s]');
ylabel('\beta_{0n} [1/s]');
title(['Stability chart of the ring setup with CCC',...
